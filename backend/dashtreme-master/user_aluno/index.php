  ...
  <div id="wrapper">
    ...
    <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
      ...
      <ul class="sidebar-menu do-nicescrol">
        ...
        <li>
          <a href="ensino.html">
            <i class="zmdi zmdi-assignment"></i> <span>Ensino</span>
          </a>
        </li>
        <li>
          <a href="componente_curricular.html">
            <i class="zmdi zmdi-calendar-note"></i> <span>Componente curricular</span>
          </a>
        </li>
        <li>
          <a href="notas.html">
            <i class="zmdi zmdi-file-text"></i> <span>Notas</span>
          </a>
        </li>
        <li>
          <a href="calendario.html">
            <i class="zmdi zmdi-calendar"></i> <span>Calendário Acadêmico</span>
          </a>
        </li>
      </ul>
    </div>
