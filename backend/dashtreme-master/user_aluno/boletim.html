    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper" data-simplebar>
            ...
            <ul class="sidebar-menu do-nicescrol">
                ...
                <li><a href="calendario.html"><i class="zmdi zmdi-calendar"></i> <span>Calendário Acadêmico</span></a>
                </li>
            </ul>
        </div>
                ...
                <div class="row justify-content-center mt-4">
                    <div class="col-lg-10">
                        <div class="card shadow-lg rounded-lg">
                            ...
                            <div class="card-body">
                                <a href="ensino.html" class="btn btn-primary btn-voltar-custom">
