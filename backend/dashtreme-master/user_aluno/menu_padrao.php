        ...
        <div id="wrapper">
            ...
            <div id="sidebar-wrapper" data-simplebar>
                ...
                <ul class="sidebar-menu do-nicescrol">
                    ...
                    <li><a href="<?= htmlspecialchars($base) ?>index.php"><i class="zmdi zmdi-view-dashboard"></i> <span>Home</span></a></li>
                    <li><a href="<?= htmlspecialchars($base) ?>ensino.php"><i class="zmdi zmdi-assignment"></i> <span>Ensino</span></a></li>
                    <li><a href="<?= htmlspecialchars($base) ?>componente_curricular.php"><i class="zmdi zmdi-calendar-note"></i> <span>Componente
                                curricular</span></a></li>
                    <li><a href="<?= htmlspecialchars($base) ?>notas.php"><i class="zmdi zmdi-file-text"></i> <span>Notas</span></a></li>
                    <li><a href="<?= htmlspecialchars($base) ?>calendario.php"><i class="zmdi zmdi-calendar"></i> <span>Calendário
                                Acadêmico</span></a>
                    </li>
                </ul>
            </div>
                                    ...
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mt-2 user-title" id="nomeAluno"><?php echo htmlspecialchars($nome); ?></h6>
                                                <p class="user-subtitle" id="nomeInstituicao"><?php echo htmlspecialchars($email); ?></p>
                                            </div>
                                        </div>
                                    </a>
                                </li>
