...
<body onload="gerarPDF()">
  ...
  <div id="doc">
    ...
    <div class="texto">
      Atestamos, para os fins a que se fizerem necessários, que <strong>Nome aluno(a)</strong>,
      CPF nº <strong>123.456.789-10</strong>, possui vínculo regular de estudante nesta instituição sob o nº de
      matrícula
      <strong>0000000</strong>.
      modalidade <strong>presencial</strong>, no turno <strong>Matutino</strong>, ofertado pela <strong>NOME DA
        INSTITUIÇÃO</strong>.
    </div>

    <div class="texto">
      Atestamos ainda, que <strong>Aluno(a)</strong> apresenta frequência global de <strong>n%</strong>
      (x por cento) no período letivo <strong id="ano-letivo">2025</strong> (<strong>13/02/2025</strong> à
  ...
  <script>
    ...
    function gerarPDF() {
      ...
      html2pdf().set({
        ...
        // Volta para a página anterior após 1 segundo
        setTimeout(() => {
          window.history.back();
        }, 1000);
      }).catch(err => {
