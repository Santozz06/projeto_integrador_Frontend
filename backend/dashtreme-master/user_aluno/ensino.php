        ...
        <div class="row justify-content-center mt-4">
          <div class="col-lg-10">
            <div class="card shadow-lg rounded-lg">
              ...
              <div class="card-body">
                <!-- EMITIR BOLETIM -->
                <a href="boletim.html" class="text-decoration-none">
                ...
                <a href="atestado_matricula.html" target="_blank" class="text-decoration-none">
                  <div class="document-option mb-4 border rounded">
                ...
                <!-- EMITIR HISTÓRICO -->
                <a href="historico.html" class="text-decoration-none">
                  <div class="document-option mb-4 border rounded">
                ...
                <a href="atestado_frequencia.html" class="text-decoration-none">
                  <div class="document-option mb-4 border rounded">
