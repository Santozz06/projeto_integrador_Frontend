            ...
            <ul class="sidebar-menu do-nicescrol">
                ...
                <li>
                    ...
                    <ul class="sidebar-submenu">
                        <li><a href="<?= htmlspecialchars($base) ?>avaliacoes.php"><i
                                    class="zmdi zmdi-check-circle"></i> Avaliações</a></li>
                        <li><a href="<?= htmlspecialchars($base) ?>atividades.php"><i
                                    class="zmdi zmdi-assignment-check"></i> Atividades</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="sidebar-submenu">
                        <li><a href="<?= htmlspecialchars($base) ?>caderno_chamada.php"><i
                                    class="zmdi zmdi-accounts-list"></i> Caderno de
                                Chamada</a></li>
                        <li><a href="<?= htmlspecialchars($base) ?>ocorrencias.php"><i
                                    class="zmdi zmdi-alert-circle"></i> Ocorrências</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="sidebar-submenu">
                        <li><a href="<?= htmlspecialchars($base) ?>normas.php"><i class="zmdi zmdi-assignment"></i>
                                Normas</a></li>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <li class="dropdown-item">
                                <a href="../public/perfil.php" style="display: flex; align-items: center; width: 100%;">
                                    <i class="zmdi zmdi-account mr-2" style="min-width: 22px; text-align: center;"></i>
                                    Perfil Acadêmico
                                </a>
                            </li>
                            <li class="dropdown-divider"></li>
