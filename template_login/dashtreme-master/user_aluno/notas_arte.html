  ...
  <div id="wrapper">
    ...
    <div id="sidebar-wrapper" data-simplebar>
      ...
      <ul class="sidebar-menu do-nicescrol">
        ...
        <li><a href="notas.html" class="active"><i class="zmdi zmdi-file-text"></i> <span>Notas</span></a></li>
          ...
          <div class="col-lg-10">
            <div class="card card-componente">
              ...
              <div class="card-body">
                ...
                <!-- Botões de Ação -->
                <div class="btn-acoes">
                  <a href="notas.html" class="btn btn-voltar">
